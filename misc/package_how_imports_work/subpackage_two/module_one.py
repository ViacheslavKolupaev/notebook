...
print(f'7. package: {__package__} | name: {__name__} | file: {__file__}')
var_sp2_mod1 = 'var_sp2_mod1'


# The functions will NOT run when the module is imported:
def func_sp2_mod1():
    print(f'11. {__name__} | object from another module: {module_one.var_sp1_mod1}')
